...
assert.match(drawingSvg, /onMouseDown=\{handleDrawingMouseDown\}/, 'the real Drawing SVG owns the mousedown experiment');
...
assert.doesNotMatch(sharedCad, /handleDrawingMouseDown/, 'the experiment is not shared CAD behavior');
assert.doesNotMatch(box, /handleDrawingMouseDown/, 'Box does not receive the experiment');

console.log('Drawing primary-mousedown experiment tests passed');
