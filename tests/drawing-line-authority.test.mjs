...
assert.deepEqual(ctrlSnap.channels, { xAlignment: null, yAlignment: null, perpendicular: null, parallel: null, pointReference: null, directionAuthority: null, rejectedRedundantDirectionRelations: [] });
