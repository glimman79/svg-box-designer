...
assert.match(workspace, /const lineResolution = resolveLineEffectivePoint\(interaction, rawPoint, snap, previousChainedAxisKind\);[\s\S]*const placementPoint = lineResolution\.effectivePoint;/, 'placement marker follows the authoritative resolved endpoint');
