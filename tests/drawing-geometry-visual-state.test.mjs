...
assert.match(css, /\.drawing-line-entity\.geometry-free \{ stroke: #[0-9a-f]{6}; \}/i);
assert.match(css, /\.drawing-line-entity\.geometry-constrained \{ stroke: #[0-9a-f]{6}; \}/i);
assert.match(css, /\.drawing-line-entity\.geometry-fully-locked \{ stroke: #111827; \}/i);
assert.match(css, /\.drawing-line-entity\.is-geometry-preselected,[\s\S]*\.drawing-line-entity\.is-geometry-dragging \{ stroke: #22d568; stroke-width: 2\.6; \}/, 'hover and drag deterministically override every base color');
