...
assert.match(styles, /\.drawing-geometry-entity\.is-inference-target\s*\{[^}]*stroke:\s*var\(--drawing-inference\);/s, 'Parallel and Perpendicular target previews use CAD blue');
