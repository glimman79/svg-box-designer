...
const connections: any = { E1: { id: 'E1', prefix: 'E', properties: { materialThicknessMm: 3, fingerWidthMm: 12, isFingerWidthManual: true } },
...
const assignments: any = {
  [owner.panel.edgeIds[0]]: { edgeAssignment: { connectionId: 'E1', edgeRole: 'A' } },
  [mate.panel.edgeIds[1]]: { edgeAssignment: { connectionId: 'E1', edgeRole: 'B' } },
...
const conflictingAssignments: any = { [owner.panel.edgeIds[0]]: { edgeAssignment: { connectionId: 'E1', edgeRole: 'A' },
...
assert(conflict.includes('owner-edge-0') && conflict.includes('owner') && conflict.includes('operation:TB:E1') && conflict.includes('operation:S:S1'), 'same-edge diagnostic lacks identity and claimants');
