...
import type { LineSegmentInteractionState } from './drawingLineSegmentSupport';
...
export const selectAcceptedLineInferenceRepresentations = (interaction?: LineSegmentInteractionState) => {
