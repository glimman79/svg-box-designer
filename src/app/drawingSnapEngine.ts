...
export const DRAWING_ENDPOINT_SNAP_ACQUIRE_PX = 7;
export const DRAWING_ENDPOINT_SNAP_RELEASE_PX = 9;
export const DRAWING_LINE_SNAP_ACQUIRE_PX = 5;
export const DRAWING_LINE_SNAP_RELEASE_PX = 7;
export const DRAWING_MIDPOINT_SNAP_ACQUIRE_PX = 7;
export const DRAWING_MIDPOINT_SNAP_RELEASE_PX = 9;
